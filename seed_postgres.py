...
def main():
    ...
    spots = [
        ...
        ("SP004", "Dhakeshwari Temple", "Dhaka", "Dhaka", "The national temple of Bangladesh, dating back to the 12th century.", None, "Year-round", 0, 1.0),
